...
export const useGameSocket = (socket, gameHandlers) => {
    ...
    useEffect(() => {
        ...
        const handleError = (data) => {
            ...
            // El nombre ya está en uso: sin esto, el jugador se quedaba en una
            // pantalla de espera para una partida a la que nunca entró
    ...
    }, [socket, setGameState, setOptionsAnswers, setHasAnswered, setMyAnswer, setCorrectOption, setScoreGroup, setTimer, setNotice, onJoinRejected]);
}