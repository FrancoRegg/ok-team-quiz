...
function AdminView() {
    ...
    const fetchQuestions = async () => {
        try {
            const response = await fetch('http://192.168.1.12:3000/api/questions');
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await fetch(`http://192.168.1.12:3000/api/questions/${id}`, {
                method: 'DELETE'
            });
            fetchQuestions(); 
        } catch (error) {
    ...
    const handleSubmit = async() => {
        ...
        try{
            let url = 'http://192.168.1.12:3000/api/questions';
            let method = 'POST';

            if (editingId) {
                url = `http://192.168.1.12:3000/api/questions/${editingId}`;
                method = 'PUT';
            }
